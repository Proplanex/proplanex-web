    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Smart ERP Intelligence for{" "}
            <span className="text-primary glow-text">Modern Textile</span>{" "}
            Production
          </motion.h1>
          ...
          >
            Proplanex helps factories manage production, inventory, and delivery 
            with AI-powered ERP tools. Streamline operations and boost efficiency.
          </motion.p>
          ...
          >
            {[
              { value: "500+", label: "Active Factories" },
